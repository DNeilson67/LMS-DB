...
urlpatterns = [
    ...
    path('admin/dashboard/students/search', views.get_student_search, name = 'get_student_search'),
    path('admin/dashboard/teachers/search', views.get_teacher_search, name = 'get_teacher_search'),
    #Student Views
